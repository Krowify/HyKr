// Rewritten without QtQuick.Layouts -- see BluetoothPanel.qml's header
// comment for why.
import Quickshell
...
PanelWindow {
    ...
    Rectangle {
        ...
        Row {
            ...
            Item { width: parent.width - 130 - 66; height: 1 } // spacer
            Rectangle {
        ...
        Row {
            ...
            Text { text: "Do Not Disturb"; color: "#c8d4d1"; font.pixelSize: 12; width: parent.width - 34 }
            Rectangle {

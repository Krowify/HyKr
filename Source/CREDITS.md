...
- [elifouts/Dotfiles](https://github.com/elifouts/Dotfiles) (GPLv3) — source of the wallpapers, and the waybar, wofi, swaync, hyprlock, nvim, starship, and pywal (`wal/`) configs.
